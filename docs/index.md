...
See [Quickstart](quickstart.md) to get running in minutes. For how EdgeAdapt relates to larger “platform” expectations (and what is explicitly out of scope), read [Platform scope](platform.md) and the [Roadmap](roadmap.md). Maintainers: [Gap analysis](gap_analysis.md) tracks strategic maturity vs the current tree.
